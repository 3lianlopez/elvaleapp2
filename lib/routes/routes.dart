...
Map<String, WidgetBuilder> getAplicationRoutes(){
  ...
  return <String, WidgetBuilder>{
    ...
    'usuario' : (context) =>  UsuarioScreen(uid: ModalRoute.of(context)!.settings.arguments as String , usuario: ModalRoute.of(context)!.settings.arguments as UsuarioSecurityModel , establecimientoInfoModel: ModalRoute.of(context)!.settings.arguments as EstablecimientoInfoModel)
  };
